@trait_438878024 = unnamed_addr constant <{ i16, i16, ptr }> <{
    i16 8,
    i16 8,
    ptr @string_fooat
}>, align 8
@trait_1215816768 = unnamed_addr constant <{ i16, i16, ptr }> <{
    i16 8,
    i16 8,
    ptr @Map_fooat
}>, align 8
@trait_1342988207 = external constant <{ i16, i16, ptr }>
...
entry:
%11 = getelementptr inbounds <{i16, i16, ptr}>, ptr @trait_1342988207, i32 0, i32 2
%12 = load ptr, ptr %11
%13 = call i32 %12(i8** %10)
%14 = getelementptr inbounds <{i16, i16, ptr}>, ptr @trait_1342988207, i32 0, i32 2
%15 = load ptr, ptr %14
...
store i8 0, i8* %26
%27 = call i32 @test()
call i1 @print_fooable(ptr @trait_438878024, i8* %22)
call i1 @print_fooable(ptr @trait_1215816768, %Map* %19)
ret void
}
define i32 @test() {
entry:
